...
/** Επιστροφή true αν υπάρχει η στήλη $col στον πίνακα $table */
...
/** Δομή full name, χωρίς να αναφερθούμε σε ανύπαρκτες στήλες */
$nameParts = [];
...
$nameExpr = count($nameParts) ? ('COALESCE('.implode(',', $nameParts).")") : "''";
...
$amExpr = count($amParts) ? ('COALESCE('.implode(',', $amParts).")") : "''";
